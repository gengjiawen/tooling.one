...
const REPO_LINK = "https://github.com/gengjiawen/tooling.one"
...
const VERSION_LINK = process.env.COMMIT_SHA
  ? `${REPO_LINK}/commit/${process.env.COMMIT_SHA}`
  : REPO_LINK
      ...
      <header className="px-5 h-12 fixed w-full left-0 top-0 items-center justify-between flex md:relative md:px-3 backdrop-blur-lg border-b">
        <div className="flex items-center h-full">
          <h1 className="text-xl font-medium">
            <Link href="/" className="flex space-x-2 items-center px-1">
                <svg
